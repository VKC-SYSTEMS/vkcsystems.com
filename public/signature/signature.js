...
const LOGO_FILE_SRC = "https://vkcsystems.com/signature/Office365Logo.png";
const ICON_BASE = "https://vkcsystems.com/signature/icons";
...
const ADDR = "89 Leuning Street, Suite E<br>South Hackensack, NJ 07606";
...
function buildSignature(name, creds, title, title2, phone, ext, cell, email, logoSrc = LOGO_FILE_SRC) {
  ...
  const cellRow = safeCell ? `
        <tr>
          <td style="padding:3px 8px 3px 0;vertical-align:middle;width:18px;" width="18">
            <img src="${ICON_BASE}/cell.png" width="14" height="14" alt="Cell" style="display:block;border:0;">
          </td>
  ...
  <tr>
    <td style="vertical-align:top;padding:8px 0;">
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
        <tr>
          <td style="padding:3px 8px 3px 0;vertical-align:middle;width:18px;" width="18">
            <img src="${ICON_BASE}/phone.png" width="14" height="14" alt="Phone" style="display:block;border:0;">
          </td>
          <td style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#444444;padding:3px 0;vertical-align:middle;">
        ...
        <tr>
          <td style="padding:3px 8px 3px 0;vertical-align:middle;width:18px;" width="18">
            <img src="${ICON_BASE}/email.png" width="14" height="14" alt="Email" style="display:block;border:0;">
          </td>
        ...
        <tr>
          <td style="padding:3px 8px 3px 0;vertical-align:middle;width:18px;" width="18">
            <img src="${ICON_BASE}/globe.png" width="14" height="14" alt="Website" style="display:block;border:0;">
          </td>
          <td style="font-family:Arial,Helvetica,sans-serif;font-size:11px;padding:3px 0;vertical-align:middle;">
        ...
        <tr>
          <td style="padding:3px 8px 3px 0;vertical-align:middle;width:18px;" width="18">
            <img src="${ICON_BASE}/pin.png" width="14" height="14" alt="Address" style="display:block;border:0;">
          </td>
